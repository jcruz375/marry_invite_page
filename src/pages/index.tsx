...
export default function Home() {  
  return (
      <main className={`max-w-6xl mx-auto`}>
        ...
        <Countdown />
        <section className={`w-4/5 mx-auto mt-44 ${styles.footer_text_section}`}>
          <p className='font-serif text-5xl'>
            Sejam bem-vindos ao nosso site!
          </p>
          <p className='font-serif text-2xl mt-11'>
            A melhor forma de compartilhar esse momento com vocês é unindo sonhos.
          </p>
        </section>
        <section className={`w-fit mx-auto ${styles.footer_section}`}>
